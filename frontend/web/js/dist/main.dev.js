...
$(function () {
  ...
  var body = document.querySelector(".header-navbar, .slider-bottom-header-sticky");
  ...
  $('.testimonial-active-2').slick((_$$slick = {
    dots: false,
    autoplay: true,
    infinite: false,
    arrows: false
  }, _defineProperty(_$$slick, "autoplay", true), _defineProperty(_$$slick, "autoplaySpeed", 4000), _defineProperty(_$$slick, "prevArrow", '<span class="prev"><i class="fal fa-chevron-left"></i></span>'), _defineProperty(_$$slick, "nextArrow", '<span class="next"><i class="fal fa-chevron-right"></i></span>'), _defineProperty(_$$slick, "speed", 800), _defineProperty(_$$slick, "slidesToShow", 3), _defineProperty(_$$slick, "slidesToScroll", 1), _defineProperty(_$$slick, "responsive", [{
    breakpoint: 1600,
    settings: {
      slidesToShow: 2,
      dots: true
  ...
  $('.testimonial-active-3').slick((_$$slick2 = {
    dots: true,
    autoplay: true,
    infinite: false,
    arrows: false
  }, _defineProperty(_$$slick2, "autoplay", true), _defineProperty(_$$slick2, "autoplaySpeed", 4000), _defineProperty(_$$slick2, "prevArrow", '<span class="prev"><i class="fal fa-chevron-left"></i></span>'), _defineProperty(_$$slick2, "nextArrow", '<span class="next"><i class="fal fa-chevron-right"></i></span>'), _defineProperty(_$$slick2, "speed", 800), _defineProperty(_$$slick2, "slidesToShow", 2), _defineProperty(_$$slick2, "slidesToScroll", 1), _defineProperty(_$$slick2, "responsive", [{
    breakpoint: 992,
    settings: {
      slidesToShow: 2
    }
  ...
  var $productPopupGalleryBtn = $('.product-gallery-popup'),
    ...
    new PhotoSwipe(pswpElement, PhotoSwipeUI_Default, items[0], options).init();
  };
