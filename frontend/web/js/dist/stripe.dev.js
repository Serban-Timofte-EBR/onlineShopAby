...
var stripe = Stripe("pk_test_51HLFOaDfku0lGfVqzVhVcJBjy4PfaBbbgxGf1CxQrwfpU131wHXSkwOkpy5wn8C3WdByDj0KO63Ff24mpQuvbnfo00sPZvmteD"); // The items the customer wants to buy
...
fetch("/abysand/site/perform-payment", {
  method: "POST",
  headers: {
...
var orderComplete = function orderComplete() {
  ...
  document.querySelector("button").disabled = true;
  setTimeout(function () {
    window.location.href = '/abysand/site/confirm-payment';
  }, 2000);
