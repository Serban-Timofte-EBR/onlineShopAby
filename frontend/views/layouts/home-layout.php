...
<div class="off-canvas-sidebar">
    <div class="off-canvas-sidebar-wrapper">
        ...
        <div class="off-canvas-sidebar-box">
            <a class="logo" href="index-11.html">
...
<section id="sliderParallax" class="slider-area slider-11 slider-active">
    <div class="single-slider bg_cover d-flex align-items-center paroller" style="background-image: url(<?= Yii::$app->Url->assetImgUrl() ?>canvasimage987654321.jpg);" data-paroller-factor="-0.15" data-paroller-type="foreground" data-paroller-direction="vertical">

        <div class="container">
            <div class="slider-content-11 text-center layer" data-depth="0.5">
                <div class="content">
                    <span class="line" data-animation="lineLeft" data-delay="0.5s"></span>
                    <h1 class="title"><span data-animation="slideInLeft" data-delay="1.3s">ABYsand</span></h1>
    ...
    <div class="single-slider bg_cover d-flex align-items-center paroller" style="background-image: url(<?= Yii::$app->Url->assetImgUrl() ?>pozacanvas12345689.jpg);" data-paroller-factor="-0.15" data-paroller-type="foreground" data-paroller-direction="vertical">
        <div class="container">
            <div class="slider-content-11 text-center layer" data-depth="0.5">
                <div class="content">
                    <span class="line" data-animation="lineLeft" data-delay="0.5s"></span>
                    <h1 class="title"><span data-animation="slideInLeft" data-delay="1.3s">Design creativ</span></h1>
                    <span class="line" data-animation="lineLeft" data-delay="1s"></span>
                </div>
            </div>
        </div>
    ...
    <div class="single-slider bg_cover d-flex align-items-center paroller" style="background-image: url(<?= Yii::$app->Url->assetImgUrl() ?>jordan-whitt-8hT4d5vX3no-unsplash.jpg);" data-paroller-factor="-0.15" data-paroller-type="foreground" data-paroller-direction="vertical">
        <div class="container">
            <div class="slider-content-11 text-center layer" data-depth="0.5">
                <div class="content">
                    <span class="line" data-animation="lineLeft" data-delay="0.5s"></span>
                    <h1 class="title"><span data-animation="slideInLeft" data-delay="1.3s">Colecții noi</span></h1>
                    <span class="line" data-animation="lineLeft" data-delay="1s"></span>
                </div>
            </div>
        </div>
